...
#from dw_three import swin_large_patch4_window7_224_in22k as create_model
...
# from parallel_thirteen import swin_large_patch4_window7_224_in22k as create_model
...
def main(args):
    ...
    # if os.path.exists("linear_weights_sw_tiny_covid_0") is False:
    #     os.makedirs("linear_weights_sw_tiny_covid_0")
    ...
    for epoch in range(args.epochs):
        ...
        # if val_acc > acc_best:
        #     torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/linear_weights_sw_tiny_covid_0")
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--data-path', type=str,
    #                   default="/mnt/data/lsy/ZZQ/covid_cross_validation/train_0/fold_4")
    # parser.add_argument('--data-path', type=str,
    #                   default="/mnt/data/lsy/new/bc17092")
