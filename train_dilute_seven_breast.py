...
def main(args):
    ...
    if os.path.exists("/mnt/data/lsy/ZZQ/weights_sw_large_parallel_thirteen_breast") is False:
        os.makedirs("/mnt/data/lsy/ZZQ/weights_sw_large_parallel_thirteen_breast")
    ...
    for epoch in range(args.epochs):
        ...
        if val_acc > acc_best:
            torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/weights_sw_large_parallel_thirteen_breast_best.pth")
