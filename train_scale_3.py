...
class Rescale:
    def __call__(self, image):
        ...
        # 计算缩放后的尺寸 (3/4 比例)
        new_width, new_height = int(original_width * 1 / 10), int(original_height * 1 / 10)
        # 缩放图片
...
def main(args):
    ...
    if os.path.exists("/mnt/data/lsy/ZZQ/weights_scale_4_sw_large_cell") is False:
        os.makedirs("/mnt/data/lsy/ZZQ/weights_scale_4_sw_large_cell")
    ...
    for epoch in range(args.epochs):
        ...
        if val_acc > acc_best:
            torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/weights_scale_4_sw_large_cell_best.pth")
