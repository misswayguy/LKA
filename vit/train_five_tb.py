...
def main(args):
    ...
    if os.path.exists("/mnt/data/lsy/ZZQ/weights_base_five_tb") is False:
        os.makedirs("/mnt/data/lsy/ZZQ/weights_base_five_tb")
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/weights_base_five_tb/model-{}.pth".format(epoch))
