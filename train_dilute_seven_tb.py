...
def main(args):
    ...
    if os.path.exists("/mnt/data/lsy/ZZQ/weights_sw_large_parallel_thirteen_tb") is False:
        os.makedirs("/mnt/data/lsy/ZZQ/weights_sw_large_parallel_thirteen_tb")
    ...
    for epoch in range(args.epochs):
        ...
        if val_acc > acc_best:
            torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/weights_sw_large_parallel_thirteen_tb_best.pth")
