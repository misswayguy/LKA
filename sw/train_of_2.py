...
def main(args):
    ...
    if os.path.exists("/mnt/data/lsy/ZZQ/weights_base_covid_2") is False:
        os.makedirs("/mnt/data/lsy/ZZQ/weights_base_covid_2")
    ...
    for epoch in range(args.epochs):
        ...
        if val_acc > acc_best:
            torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/weights_base_covid_2_best.pth")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', default='cuda:3', help='device id (i.e. 3 or 0,1,2,3,4,5 or cpu)')
    parser.add_argument('--train-ratio', type=float, default=0.2, help='training set ratio (e.g., 0.2 for 20%)')
