...
def main(args):
    ...
    if os.path.exists("/mnt/data/lsy/ZZQ/weights_sw_large_parallel_thirteen_cell") is False:
        os.makedirs("/mnt/data/lsy/ZZQ/weights_sw_large_parallel_thirteen_cell")
    ...
    for epoch in range(args.epochs):
        ...
        if val_acc > acc_best:
            torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/weights_sw_large_parallel_thirteen_cell_best.pth")
            print('save model in epoch {}'.format(epoch))

        #torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/weights_sw_large_cell/model-{}.pth".format(epoch))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', default='cuda:3', help='device id (i.e. 0 or 0,1,2,3,4,5 or cpu)') #改GPU
