...
def main(args):
    ...
    if os.path.exists("/mnt/data/lsy/ZZQ/weights_base_covid") is False:
        os.makedirs("/mnt/data/lsy/ZZQ/weights_base_covid")
    ...
    for epoch in range(args.epochs):
        ...
        if val_acc > acc_best:
            torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/weights_base_covid_best.pth")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', default='cuda:4', help='device id (i.e. 5 or 0,1,2,3,4,5 or cpu)')
    parser.add_argument('--train-ratio', type=float, default=0.8, help='training set ratio (e.g., 0.8 for 80%)')
