...
def main(args):
    ...
    if os.path.exists("/mnt/data/lsy/ZZQ/weights_sw_large_parallel_thirteen_covid") is False:
        os.makedirs("/mnt/data/lsy/ZZQ/weights_sw_large_parallel_thirteen_covid")
    ...
    for epoch in range(args.epochs):
        ...
        if val_acc > acc_best:
            torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/weights_sw_large_parallel_thirteen_covid_best.pth")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', default='cuda:2', help='device id (i.e. 5 or 0,1,2,3,4,5 or cpu)') #改GPU
