...
def main(args):
    ...
    if os.path.exists("/mnt/data/lsy/ZZQ/weights_scale_1_sw_large_cell") is False:
        os.makedirs("/mnt/data/lsy/ZZQ/weights_scale_1_sw_large_cell")
    ...
    for epoch in range(args.epochs):
        ...
        if val_acc > acc_best:
            torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/weights_scale_1_sw_large_cell_best.pth")
