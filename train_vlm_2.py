...
def main(args):
    ...
    # if os.path.exists("fiftyone_five_weights_sw_tiny_covid_10") is False:
    #     os.makedirs("fiftyone_five_weights_sw_tiny_covid_10")
...
# if args.freeze_layers:
    ...
    for epoch in range(args.epochs):
        ...
        # if val_acc > acc_best:
        #     torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/fiftyone_five_weights_sw_tiny_covid_10")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str,
                      default="/mnt/data/lsy/ZZQ/cifar-100_cross_validation/train_20")
