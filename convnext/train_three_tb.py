...
def main(args):
    ...
    if os.path.exists("/mnt/data/lsy/ZZQ/weights_convnext_three_tb") is False:
        os.makedirs("/mnt/data/lsy/ZZQ/weights_convnext_three_tb")
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/weights_convnext_three_tb/model-{}.pth".format(epoch))
