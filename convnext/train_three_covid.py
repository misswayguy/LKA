...
def main(args):
    ...
    if os.path.exists("/mnt/data/lsy/ZZQ/weights_convnext_three_covid") is False:
        os.makedirs("/mnt/data/lsy/ZZQ/weights_convnext_three_covid")
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/weights_convnext_three_covid/model-{}.pth".format(epoch))
