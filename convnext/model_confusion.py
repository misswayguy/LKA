...
#from v2_res_conv import convnext_tiny as create_model
...
if __name__ == '__main__':
    ...
    # 训练权重路径
    parser.add_argument('--weights', type=str, default='/home/z/zz257/project/prompt/promot/convnext/weights_tiny_TB/model-19.pth',
