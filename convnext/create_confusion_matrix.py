...
# three import convnext_small as create_model
...
if __name__ == '__main__':
    ...
    # 训练权重路径
    parser.add_argument('--weights', type=str, default='/mnt/data/lsy/ZZQ/weights_convnext_large_five_brain/model-59.pth',
