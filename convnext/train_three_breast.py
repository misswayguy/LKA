...
def main(args):
    ...
    if os.path.exists("/mnt/data/lsy/ZZQ/weights_convnext_three_breast") is False:
        os.makedirs("/mnt/data/lsy/ZZQ/weights_convnext_three_breast")
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/weights_convnext_three_breast/model-{}.pth".format(epoch))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', default='cuda:4', help='device id (i.e. 0 or 0,1,2,3,4,5 or cpu)') #改GPU
