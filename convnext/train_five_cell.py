...
def main(args):
    ...
    if os.path.exists("/mnt/data/lsy/ZZQ/weights_convnext_large_five_cell") is False:
        os.makedirs("/mnt/data/lsy/ZZQ/weights_convnext_large_five_cell")
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "/mnt/data/lsy/ZZQ/weights_convnext_large_five_cell/model-{}.pth".format(epoch))
